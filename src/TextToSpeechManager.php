...
namespace codicastudio\TextToSpeech;

use Aws\Credentials\Credentials;
use Aws\Polly\PollyClient;
use codicastudio\TextToSpeech\Converters\NullConverter;
use codicastudio\TextToSpeech\Converters\PollyConverter;
use Exception;
...
class TextToSpeechManager extends Manager
{
     ...
     *
     * @return \codicastudio\TextToSpeech\Converters\PollyConverter
     */
     ...
     *
     * @return \codicastudio\TextToSpeech\Converters\NullConverter
     */
