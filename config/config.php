...
return [
    ...
    'audio' => [
         ...
         */
        'formatter' => \codicastudio\TextToSpeech\Formatters\DefaultFilenameFormatter::class,
    ],
     ...
     *
     * @see \codicastudio\TextToSpeech\Contracts\Source
     */
    'sources' => [
        'text'    => \codicastudio\TextToSpeech\Sources\TextSource::class,
        'path'    => \codicastudio\TextToSpeech\Sources\PathSource::class,
        'website' => \codicastudio\TextToSpeech\Sources\WebsiteSource::class,
    ],
